...
_SYSTEM_RULES = (
    ...
    "Every generated component must correspond to one entry from the normalized planning JSON. "
    ...
    "10. **No Orchestration Layers**: Do not introduce intermediate orchestration layers "
    "(e.g., Workflow Orchestration, Business Orchestrator, Claim Workflow, Processing Engine, "
    "Execution Engine, Pipeline Manager) unless explicitly present.\n"
