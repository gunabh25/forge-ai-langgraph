...
class DiagramScoreCard(BaseModel):
    ...
    visual_density_score: float = Field(100.0, ge=0.0, le=100.0, description="Canvas element density ratio")
    label_overlap_score: float = Field(100.0, ge=0.0, le=100.0, description="Label wrapping and crowding penalty")
    average_edge_length_score: float = Field(100.0, ge=0.0, le=100.0, description="Average span distance optimization")
    package_balance_score: float = Field(100.0, ge=0.0, le=100.0, description="Package size imbalance penalty")
    symmetry_score: float = Field(100.0, ge=0.0, le=100.0, description="Graph visual symmetry")
